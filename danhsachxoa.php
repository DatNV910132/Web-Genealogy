    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">
                Danh sách Thành viên Cây phả hệ
            </h1>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    foreach ($merge as $item):
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="xoanguoi.php?id=<?php echo $item['id'] ?>&level=<?php echo $item['lv'] ?>&idtree=<?php echo $id?>" method="POST" name="bcdonline" onSubmit="return confirmAction()">
